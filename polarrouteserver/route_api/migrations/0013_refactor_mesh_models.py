# Generated by custom migration for mesh refactoring
...
def migrate_mesh_data(apps, schema_editor):
    # We need to use raw SQL here since the models will be in transition
...
class Migration(migrations.Migration):
    ...
    operations = [
        # Step 1: Create VehicleMesh table
        ...
        # Step 2: Migrate data from Mesh to VehicleMesh and update Route references
        migrations.RunPython(
            migrate_mesh_data,
            reverse_migrate_mesh_data,
        ),
        # Step 3: Update Route.mesh to point to VehicleMesh
        ...
        # Step 4: Rename Mesh to EnvironmentMesh
        migrations.RenameModel(
            old_name="Mesh",
            new_name="EnvironmentMesh",
        ),
        # Step 5: Set correct Meta options for EnvironmentMesh
        migrations.AlterModelOptions(
            name="environmentmesh",
            options={"verbose_name_plural": "Environment Meshes"},
        ),
        # Step 6: Update VehicleMesh.environment_mesh to point to EnvironmentMesh
        migrations.AlterField(
